  ...
  render() {
    return (
      <View style={GlobalStyle.fullPageContainer}>
        ...
        <View style={[GlobalStyle.pageContainer, GlobalStyle.container, { alignItems: 'center' }]}>
          <MaterialIcons name="gps-off" color="rgba(0, 0, 0, 0.38)" size={48} />
          <Text style={styles.description}>
            I would love to show you the ladies in your area but.. You haven&apos;t switched on GPS yet.
          </Text>
